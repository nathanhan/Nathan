...
ACLOCAL = ${SHELL} /xchip/gistic/Jeremiah/GIT/Nathan/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /xchip/gistic/Jeremiah/GIT/Nathan/missing --run tar
AM_CXXFLAGS = -g -std=c++11 -Wall -Wextra  -Wno-unknown-pragmas
AUTOCONF = ${SHELL} /xchip/gistic/Jeremiah/GIT/Nathan/missing --run autoconf
AUTOHEADER = ${SHELL} /xchip/gistic/Jeremiah/GIT/Nathan/missing --run autoheader
AUTOMAKE = ${SHELL} /xchip/gistic/Jeremiah/GIT/Nathan/missing --run automake-1.9
AWK = gawk
CC = gcc
...
infodir = ${prefix}/info
install_sh = /xchip/gistic/Jeremiah/GIT/Nathan/install-sh
